<template>
  <div class="goods">
    <div class="menu-wrapper" ref="menuWrapper">
      ...
      <ul>
        <li v-for="(item,index) in goods" @click="menuClick(index,$event)" :class="index==menuCurrentIndex?'menu-item-selected':'menu-item'" :key='index'>
          <span class="text">
    ...
    <shopCart :deliveryPrice="getseller.deliveryPrice" :minPrice = "getseller.minPrice" :selectFoods="selectFoods"></shopCart>
...
export default {
 ...
 //      })
    ...
    menuClick(index, event) {
      ...
      this.foodsScroll.scrollTo(0, -this.listHeight[index], 700)
    },
    goDetail(food) {
  ...
  props: ['getseller'],
  components: {iconMap, ShopCart, cartcontrol, foodDetail}
